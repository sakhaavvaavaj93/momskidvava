...
from momskidvava.decorators import authorized_users_only, sudo_users_only, errors
from momskidvava.filters import command, other_filters
from momskidvava.main import Test as USER
from pyrogram import filters
from momskidvava.main import bot as Client, bot as app
from pyrogram.errors import UserAlreadyParticipant
from momskidvava.Client.assistant import get_assistant_details, random_assistant
from momskidvava.Database.active import get_active_chats


@app.on_message(filters.command("join", "ubjoin"))
