...
import aiofiles
import aiohttp
from momskidvava.converter import convert
import ffmpeg
import requests
from momskidvava.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from config import ASSISTANT_NAME, BOT_USERNAME, QUE_IMG, START_PIC, PLAY_IMG, UPDATES_CHANNEL, GROUP_SUPPORT
...
from momskidvava.utils import bash
...
from momskidvava.Client.assistant import get_assistant_details, random_assistant
from momskidvava.Client.Joiner import AssistantAdd
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    images = choice(momskidvava_IMGS)
