from momskidvava.Cache.admins import admins
from momskidvava.main import call_py, call_py2, call_py3, call_py4, call_py5
from pyrogram import filters
from momskidvava.main import bot as Client
from momskidvava.decorators import authorized_users_only
from momskidvava.filters import command, other_filters
from momskidvava.queues import QUEUE, clear_queue
from momskidvava.utils import skip_current_song, skip_item
...
from momskidvava.Database.active import remove_active_video_chat, remove_active_chat
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            ...
            await m.reply_text(f"⏭ **Skipped to the next track.**")
    else:
